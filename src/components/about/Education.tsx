      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="space-y-4">
          {portfolio.education.map((edu, i) => (
            ...
            >
              {/* Icon/Logo */}
              {edu && "logo" in edu && typeof edu.logo === "string" && edu.logo && (
                <div className="flex h-15 w-15 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border bg-white shadow-sm">
                  <img
                    src={edu.logo}
